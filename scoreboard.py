...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        # None means default style and 48 means size
    ...
    def prep_score(self):
        ...
        # value to the nearest 10, 100, 1000, and so on. The code at tells
        # Python to round the value of stats.score to the nearest 10 and store
        # it in rounded_score.
